<template>
  <form @submit.prevent class="md:pt-[.81rem] md:pl-4">
    ...
    <div class="mt-8 md:mt-10 flex flex-col gap-4 group">
      <p class="text-[1rem] font-bold font-spaceMono text-[#5E7A7D]" :class="{ 'group-focus-within:text-[#26C2AE]': !isDoneByCustom }">Select Tip %</p>
